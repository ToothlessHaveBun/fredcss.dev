    ...
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      <div className="hidden sm:block my-16 text-center animate-fade-in">
        <h2 className="px-8 text-sm text-zinc-500 select-none">
          Hi there, I'm <span className={"font-bold"}>Frederick Chen</span>. I'm a
          student based in {" "}
          <span className={"underline underline-offset-1"}>China</span>.
          <div className={"mt-1"}>
            I'm also a front-end developer and I love make some interesting projects.
          </div>
        </h2>
      </div>
      <div
      ...
      >
        <h2 className="px-8 text-sm text-zinc-500 ">
          ...
          <span className={"underline underline-offset-1"}>China</span>.
          <div className={"mt-2"}>
            Developer / Blogger / Photographer
          </div>
        </h2>
      </div>
    </div>
